...
const cardData = [
  ...
  },
  {
    ...
    description: (
      <div className="mt-2  h-80" style={{ clipPath: "inset(0 0 10% 0)" }}>
...
export function Globe({ className = "", style, config = GLOBE_CONFIG }) {
  ...
  return (
    <div
      className={`absolute inset-0 mx-auto aspect-square w-full max-w-[37.5rem] ${className}`}
      style={style}
    >
      <canvas
...
const BentoCardGrid = ({ children, gridRef }) => (
  <div
    className="bento-section grid gap-4 p-3 max-w-7xl w-full select-none relative mx-auto"
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-4">
          {cardData.map((card, index) => {
            const baseClassName = `card flex flex-col justify-between relative aspect-[4/3] min-h-[300px] w-full max-w-full p-6 rounded-[24px] border border-solid font-light overflow-hidden transition-colors duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-[0_8px_25px_rgba(0,0,0,0.15)] ${
