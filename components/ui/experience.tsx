...
const experience = {
  ...
  highlights: [
    "Reviewed and merged 190+ Pull Requests, ensuring high code quality and architectural consistency.",
    "Managed a diverse community of 85+ contributors to build complex visualization modules.",
    "Project metrics: 125+ Forks, 40+ Stars, and growing rapidly.",
  ],
  stats: [
    { label: "PRs Merged", value: "190+" },
    { label: "Forks", value: "125+" },
